  ...
  if (insights.length === 0) {
    return (
      <div className="rounded-lg bg-white p-8 text-center shadow">
        <Lightbulb className="mx-auto mb-3 h-12 w-12 text-gray-400" />
        <h3 className="mb-2 text-lg font-medium text-gray-900">No Insights Yet</h3>
...
function InsightCard({ insight }: { insight: Insight }) {
  ...
  return (
    <div
      className={`rounded-lg border-l-4 bg-white p-4 shadow ${priorityColors[insight.priority]} transition-shadow hover:shadow-md`}
    >
      <div className="flex items-start gap-3">
        <Icon className="mt-1 h-5 w-5 flex-shrink-0 text-gray-700" />
        <div className="min-w-0 flex-1">
          ...
          <div className="mb-2 rounded border border-gray-200 bg-white p-3">
            <p className="mb-1 text-xs font-medium text-gray-600">Recommended Action:</p>
