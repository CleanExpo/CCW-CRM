...
# Create limiter instance with Redis storage (fallback to memory if Redis unavailable)
# Use memory:// for development when Redis is not running
storage_uri = settings.redis_url if settings.redis_url and "redis://" in settings.redis_url else "memory://"
