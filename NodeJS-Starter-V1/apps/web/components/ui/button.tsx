...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-brand-primary-600 text-white shadow-sm hover:bg-brand-primary-700 dark:bg-brand-primary-600 dark:hover:bg-brand-primary-700 active:scale-[0.98] transition-transform",
        destructive:
        ...
        link:
          "text-brand-primary-600 dark:text-brand-primary-400 underline-offset-4 hover:underline hover:text-brand-primary-700 dark:hover:text-brand-primary-300",
