...
import { useRealTimeBackorders } from "@/hooks/use-real-time-backorders";
import {
  Package,
  Clock,
  Calendar,
...
export default function BackordersPage() {
  ...
  // Enable real-time backorder updates via WebSocket
  useRealTimeBackorders({
    showNotifications: true,
    onBackorderUpdate: loadBackorders,
  });
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => router.push(`/orders/${backorder.order_id}` as any)}
                >
