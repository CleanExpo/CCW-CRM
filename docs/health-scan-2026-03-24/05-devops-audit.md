...
| Environment Configuration | 12/20 | Thorough .env.example; NEXT_PUBLIC_ leak, no production .env validation |
...
<li>Check Prometheus alerts: <a href="http://localhost:9090/alerts">http://localhost:9090/alerts</a></li>
```
