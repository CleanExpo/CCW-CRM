      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="flex items-center justify-between border-b pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-foreground text-3xl font-bold">CCW ERP - i18n Demo</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Common UI elements from "common" namespace</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-sm">{t('common.filter')}</p>
                <p className="text-muted-foreground text-sm">{t('common.refresh')}</p>
              </div>
              <div className="space-y-1">
                <p className="text-muted-foreground text-sm">{t('common.export')}</p>
                <p className="text-muted-foreground text-sm">{t('common.import')}</p>
                <p className="text-muted-foreground text-sm">{t('common.viewAll')}</p>
              </div>
              <div className="space-y-1">
                <p className="text-muted-foreground text-sm">{t('common.name')}</p>
                <p className="text-muted-foreground text-sm">{t('common.description')}</p>
                <p className="text-muted-foreground text-sm">{t('common.status')}</p>
              </div>
              <div className="space-y-1">
                <p className="text-muted-foreground text-sm">{t('common.date')}</p>
                <p className="text-muted-foreground text-sm">{t('common.total')}</p>
                <p className="text-muted-foreground text-sm">{t('common.quantity')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Navigation menu items</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Product categories with industry-specific terminology</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {[
                ...
                <div
                  key={category}
                  className="bg-card hover:bg-accent flex items-center gap-2 rounded-lg border p-3 transition-colors"
                >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Order status translations with icons</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Dashboard section translations</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="rounded-lg bg-blue-50 p-4 text-center dark:bg-blue-950">
                ...
                <p className="text-muted-foreground text-sm">{t('dashboard.orders')}</p>
              </div>
              <div className="rounded-lg bg-green-50 p-4 text-center dark:bg-green-950">
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">5,678</p>
                <p className="text-muted-foreground text-sm">{t('dashboard.customers')}</p>
              </div>
              <div className="rounded-lg bg-purple-50 p-4 text-center dark:bg-purple-950">
                <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">$123,456</p>
                <p className="text-muted-foreground text-sm">{t('dashboard.revenue')}</p>
              </div>
              <div className="rounded-lg bg-orange-50 p-4 text-center dark:bg-orange-950">
                <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">9,012</p>
                <p className="text-muted-foreground text-sm">{t('dashboard.sales')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Error and validation messages</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-primary text-primary-foreground">
          <CardContent className="pt-6">
            <div className="space-y-2 text-center">
              <p className="text-lg font-semibold">{t('dashboard.welcome')} 👋</p>
