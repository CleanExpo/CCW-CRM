      ...
      <div className="mx-auto max-w-4xl bg-white p-8 print:p-0">
        ...
        <div className="mt-8 border-t-2 border-gray-200 pt-6">
          ...
          <div className="text-muted-foreground space-y-2 text-xs">
            <p>
              <strong>Payment Terms:</strong> Payment is due within 30 days of invoice date. Late
              payments may incur interest charges.
            </p>
            <p>
              <strong>Delivery:</strong> Goods remain the property of Equipment ERP until payment is
              received in full.
            </p>
            <p>
              <strong>Returns:</strong> Returns must be authorized within 14 days of delivery. Goods
              must be in original condition.
            </p>
            <p>
              <strong>Warranty:</strong> All products carry manufacturer's warranty. Please refer to
