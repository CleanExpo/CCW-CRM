...
export default function InsightsPage() {
  ...
  const handleGenerateInsights = async () => {
    ...
    try {
      const request: GenerateInsightsRequest = {
        category: selectedCategory as GenerateInsightsRequest['category'],
        filters: {},
      };
  ...
  const filteredInsights = insights.filter((insight) => {
    const matchesCategory = activeTab === 'all' || insight.category === activeTab;
    ...
    <div className="container mx-auto space-y-6 py-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="inventory">Inventory ({categoryCounts.inventory || 0})</TabsTrigger>
          <TabsTrigger value="customers">Customers ({categoryCounts.customers || 0})</TabsTrigger>
          <TabsTrigger value="orders">Orders ({categoryCounts.orders || 0})</TabsTrigger>
        </TabsList>
