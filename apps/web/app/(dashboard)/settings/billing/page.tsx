          ...
          {subscription ? (
            <div className="space-y-4">
              ...
              {subscription.trial_ends_at && subscription.status === "trial" && (
                <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-md text-blue-700 text-sm">
            ...
            <div className="space-y-2">
              {invoices.map((invoice) => (
                <div key={invoice.id} className="flex items-center justify-between p-3 border rounded-md">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="font-semibold text-sm">{formatCurrency(invoice.amount_paid)}</span>
                    <Badge
