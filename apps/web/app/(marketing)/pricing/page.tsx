...
export const metadata: Metadata = {
  ...
  description: "Transparent pricing for growing equipment supplier businesses. Start free, scale as you grow.",
};
            ...
            >
              ...
              <CardFooter>
                <Button
                  ...
                  asChild
                >
                  <Link href={plan.tier === "custom" ? "/contact" : "/login"}>
                    {plan.cta}
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-center py-4 font-semibold bg-primary/5">Professional</th>
                    <th className="text-center py-4 font-semibold">Enterprise</th>
                    <th className="text-center py-4 font-semibold">Custom</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="text-center bg-primary/5">3</td>
                  ...
                  <tr className="border-b">
                    ...
                    <td className="text-center bg-primary/5">5</td>
                    <td className="text-center">Unlimited</td>
                    <td className="text-center">Unlimited</td>
                  </tr>
                  <tr className="border-b">
                    ...
                    <td className="text-center bg-primary/5">Unlimited</td>
                    <td className="text-center">Unlimited</td>
                    <td className="text-center">Unlimited</td>
                  </tr>
                  <tr className="border-b">
                    ...
                    <td className="text-center bg-primary/5">100/month</td>
                    <td className="text-center">Unlimited</td>
                    <td className="text-center">Unlimited</td>
                  </tr>
                  <tr className="border-b">
                    ...
                    <td className="text-center">-</td>
                    <td className="text-center bg-primary/5">-</td>
                  ...
                  <tr>
                    ...
                    <td className="text-center bg-primary/5">12h</td>
