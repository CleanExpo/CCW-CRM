...
async def generate_demo_purchases() -> None:
    ...
    print("   [OK] Created 5 demonstration customers")
    print("   [OK] Generated 3 quotes (2 accepted, 1 sent)")
    print("   [OK] Generated 4 orders (1 delivered, 1 shipped, 1 processing, 1 confirmed)")
    print("\nScenarios Created:")
