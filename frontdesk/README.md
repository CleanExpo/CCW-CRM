# CCW-ERP-CRM — AI Front Desk (scaffold)
...
CCW-ERP-CRM's instance of the portfolio **AI Front Desk** — a single agent "brain"
...
- **This desk's job:** Client intake, job booking, and quotes for the CCW cleaning business — answer, qualify, schedule, and quote.
- **Lead channel:** phone + web chat
- **Stack it plugs into:** Next.js 16 · Prisma
...
3. Set `CCW_FRONT_DESK_ENABLED=true` in the environment to enable; unset/false = fully dark.
