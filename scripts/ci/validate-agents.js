...
// commit. The directory was therefore always missing there, and every `boardroom-ci.yml` run
// reported success having read nothing. Tracking the agents fixes today's checkout; exiting
// non-zero here is what stops the vacuum returning the moment someone re-ignores or deletes them.
