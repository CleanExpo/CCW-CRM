...
type: 'page'
id: 'PAGE-XXX'
route: '/dashboard/workshop/equipment/[id]'
...
Page at /dashboard/workshop/equipment/[id]

<!-- AUTO-GENERATED -->

## Route Information

**URL**: `/dashboard/workshop/equipment/[id]`
**Layout**: Dashboard layout with sidebar
**Authentication**: Required (JWT)

## API Endpoints Used

- `workshopApi.updateHours()` - Purpose TBD
- `workshopApi.getEquipment()` - Purpose TBD
