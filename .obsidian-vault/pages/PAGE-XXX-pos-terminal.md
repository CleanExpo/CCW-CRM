...
# PAGE-XXX: Payment Successful

## Overview

Page at /dashboard/pos/terminal
...
- `GET /api/pos/staff` - Purpose TBD
- `POST /api/pos/transactions` - Purpose TBD
- `GET /api/pos/terminals` - Purpose TBD
