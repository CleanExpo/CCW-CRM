...
type: 'page'
id: 'PAGE-XXX'
route: '/dashboard/workshop/templates'
...
Page at /dashboard/workshop/templates

<!-- AUTO-GENERATED -->

## Route Information

**URL**: `/dashboard/workshop/templates`
**Layout**: Dashboard layout with sidebar
**Authentication**: Required (JWT)

## API Endpoints Used

- `workshopApi.listTemplates()` - Purpose TBD
- `workshopApi.deactivateTemplate()` - Purpose TBD
