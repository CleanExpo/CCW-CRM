...
type: 'page'
id: 'PAGE-XXX'
route: '/dashboard/settings/integrations/gl'
...
# PAGE-XXX: Chart of Accounts Synced

## Overview

Page at /dashboard/settings/integrations/gl

<!-- AUTO-GENERATED -->

## Route Information

**URL**: `/dashboard/settings/integrations/gl`
