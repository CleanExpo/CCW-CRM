...
Page at /dashboard/inventory/bom

<!-- AUTO-GENERATED -->

## Route Information

**URL**: `/dashboard/inventory/bom`
...
- ``: Purpose TBD
- `DropdownMenu`: Purpose TBD
- `DropdownMenuContent`: Purpose TBD
- `DropdownMenuItem`: Purpose TBD
- `DropdownMenuTrigger`: Purpose TBD
- ``: Purpose TBD
- `Input`: Purpose TBD
- `Label`: Purpose TBD
- `Table`: Purpose TBD
