...
type: 'page'
id: 'PAGE-XXX'
route: '/dashboard/workshop/reminders'
...
Page at /dashboard/workshop/reminders

<!-- AUTO-GENERATED -->

## Route Information

**URL**: `/dashboard/workshop/reminders`
**Layout**: Dashboard layout with sidebar
**Authentication**: Required (JWT)

## API Endpoints Used

- `workshopApi.listReminders()` - Purpose TBD
- `workshopApi.generateReminders()` - Purpose TBD
- `workshopApi.sendPendingReminders()` - Purpose TBD
- `workshopApi.suppressReminder()` - Purpose TBD
- `workshopApi.sendReminder()` - Purpose TBD
