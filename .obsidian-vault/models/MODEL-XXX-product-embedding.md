...
| embedding            | list     | TBD         | Column description |
| model_version        | str      | TBD         | Column description |
| model_provider       | str      | TBD         | Column description |
| generated_from       | Unknown  | TBD         | Column description |
| generation_timestamp | datetime | TBD         | Column description |
