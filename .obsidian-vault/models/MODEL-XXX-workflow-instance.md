...
| template_id         | Unknown  | TBD         | Column description |
| trigger_entity_type | str      | TBD         | Column description |
| trigger_entity_id   | Unknown  | TBD         | Column description |
