...
| shopify_metafield_id | Unknown  | TBD         | Column description |
| namespace            | str      | TBD         | Column description |
| key                  | str      | TBD         | Column description |
| value                | Unknown  | TBD         | Column description |
| value_type           | str      | TBD         | Column description |
