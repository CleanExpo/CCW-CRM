...
**Table Name**: `cin7_stock_adjustments`
...
| adjustment_qty     | Mapped | TBD         | Column description |
| reason             | Mapped | TBD         | Column description |
| cin7_adjustment_id | Mapped | TBD         | Column description |
