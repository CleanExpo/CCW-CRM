...
**Table Name**: `cin7_production_runs`
...
| cin7_production_id | Mapped | TBD         | Column description |
| quantity_planned   | Mapped | TBD         | Column description |
| quantity_completed | Mapped | TBD         | Column description |
| status             | Mapped | TBD         | Column description |
| planned_date       | Mapped | TBD         | Column description |
| completed_date     | Mapped | TBD         | Column description |
