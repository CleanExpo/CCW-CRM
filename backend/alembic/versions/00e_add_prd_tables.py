...
down_revision: str | None = "d4f7a9b2e5c1"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Status tracking
        sa.Column(
            "status", sa.String(50), default="generating", nullable=False
        ),  # generating, completed, failed
        sa.Column("error_message", sa.Text, nullable=True),
        # Model info
        sa.Column("model_used", sa.String(100), default="claude-opus-4-6"),
        # Timestamps
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "prd_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("prds.id", ondelete="CASCADE"),
            nullable=True,
        ),
        # API details
    ...
    op.create_table(
        ...
        # Status tracking
        sa.Column(
            "status", sa.String(50), nullable=False, default="running"
