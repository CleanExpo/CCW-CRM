...
export const opCardClass =
  'border-border bg-card text-card-foreground shadow-sm shadow-[inset_0_1px_0_0_hsl(var(--foreground)/0.04)] dark:shadow-[inset_0_1px_0_0_hsl(var(--primary)/0.07)] [.operations-route-scope_&]:border-white/10 [.operations-route-scope_&]:bg-card [.inventory-route-scope_&]:border-white/10 [.inventory-route-scope_&]:bg-card [.crm-route-scope_&]:border-white/10 [.crm-route-scope_&]:bg-card';

export const opTableWrapClass =
  'overflow-hidden rounded-xl border border-border bg-card shadow-sm shadow-[inset_0_1px_0_0_hsl(var(--foreground)/0.04)] dark:shadow-[inset_0_1px_0_0_hsl(var(--primary)/0.06)] [.operations-route-scope_&]:border-white/10 [.operations-route-scope_&]:bg-card [.inventory-route-scope_&]:border-white/10 [.inventory-route-scope_&]:bg-card [.crm-route-scope_&]:border-white/10 [.crm-route-scope_&]:bg-card';

export const opInsetClass =
  'rounded-xl border border-border bg-muted/40 [.operations-route-scope_&]:border-white/10 [.operations-route-scope_&]:bg-muted/50 [.inventory-route-scope_&]:border-white/10 [.inventory-route-scope_&]:bg-muted/50 [.crm-route-scope_&]:border-white/10 [.crm-route-scope_&]:bg-muted/50';
