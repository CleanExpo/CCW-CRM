...
export function ExportDialog({ open, onOpenChange, bankAccountId }: ExportDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[450px]">
        <DialogHeader>
          ...
          <DialogDescription>Export reconciliation data as CSV file</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={status}
              onValueChange={(value: string) => setStatus(value as 'all' | 'matched' | 'unmatched')}
            >
              <SelectTrigger>
          ...
          <div className="bg-muted text-muted-foreground rounded-md p-3 text-sm">
            <p>
              CSV will include: Date, Bank Transaction ID, Description, Amount, POS Transaction ID,
              Match Status, Discrepancy, and Notes.
            </p>
          </div>
        </div>
