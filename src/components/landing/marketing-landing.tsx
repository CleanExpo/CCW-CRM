                ...
                <div className="relative flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-10">
                  ...
                  <BentoCardHeader className="min-w-0 flex-1 space-y-3 text-left">
                    ...
                    <BentoCardDescription className="text-base leading-relaxed text-zinc-300">
                      Quotes, orders, line items, and fulfilment status linked so sales, warehouse,
                      and finance stop debating which spreadsheet is the real one.
                    </BentoCardDescription>
                  </BentoCardHeader>
                </div>
                ...
                <div className="relative flex flex-col gap-6 md:flex-row md:items-start md:gap-8">
                  ...
                  <BentoCardHeader className="min-w-0 flex-1 space-y-3 text-left">
                    ...
                    <BentoCardDescription className="text-base leading-relaxed text-zinc-300">
                      ...
                      inventory, service—not as a disconnected novelty. Training strategy focuses on
                      discoverability and adoption, not checkbox demos.
                    </BentoCardDescription>
                  </BentoCardHeader>
                </div>
