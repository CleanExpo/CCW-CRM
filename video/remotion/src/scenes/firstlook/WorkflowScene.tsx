...
export const WorkflowScene: React.FC = () => {
  ...
  const footerOpacity = interpolate(frame, [700, 800], [0, 1], {
  ...
  const previewOpacity = interpolate(frame, [60, 90], [0, 1], {
    extrapolateRight: 'clamp',
    extrapolateLeft: 'clamp',
  });
    ...
    >
      ...
      >
        {steps.map((step, i) => {
          ...
          const arrowWidth =
            i < steps.length - 1
              ? interpolate(frame, [arrowDelay, arrowDelay + 30], [0, 100], {
                  extrapolateRight: 'clamp',
                  extrapolateLeft: 'clamp',
                })
              : 0;
      ...
      <div
        style={{
          ...
          borderRadius: 12,
          overflow: 'hidden',
          border: `2px solid ${steps[activeStep].color}60`,
          boxShadow: `0 8px 32px ${steps[activeStep].color}30`,
        }}
      >
        <div
          style={{
