...
export const WhoItsForScene: React.FC = () => {
  ...
  const footerOpacity = interpolate(frame, [450, 550], [0, 1], {
    extrapolateRight: 'clamp',
    extrapolateLeft: 'clamp',
  });
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        {personas.map((p, i) => {
          const opacity = interpolate(frame, [20 + i * 90, 40 + i * 90], [0, 1], {
            extrapolateRight: 'clamp',
            extrapolateLeft: 'clamp',
          });
          return (
            <div
              key={i}
              style={{ opacity, display: 'flex', alignItems: 'center', gap: 20, marginBottom: 20 }}
            >
              <div
                style={{
                  width: 6,
