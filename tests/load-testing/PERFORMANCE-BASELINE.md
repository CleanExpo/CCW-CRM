...
export default function (data) {
  ...
  switch (scenarioSet) {
    case 1: runAuthenticationScenarios(); break;  // 10 scenarios
    case 2: runProductScenarios(); break;         // 15 scenarios
    case 3: runCustomerScenarios(); break;        // 15 scenarios
    case 4: runOrderScenarios(); break;           // 20 scenarios
    case 5: runQuoteScenarios(); break;           // 15 scenarios
